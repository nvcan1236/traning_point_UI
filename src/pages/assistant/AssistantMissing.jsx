...
export default function AssistantMissing() {
  return (
    <div className="mt-6 px-6">
      <Heading>Danh sách báo thiếu</Heading>
      <div className="mt-5">
...
const MissingItem = () => {
  ...
  return (
    <li className="flex py-4 px-3 text-center transition-all hover:bg-slate-50 rounded-lg cursor-pointer" onClick={()=>navigate('./1')}>
      ...
      <span className="flex-1"><span className="px-3 py-1 rounded-md bg-yellow-100 text-yellow-500">Chờ duyệt</span></span>
    </li>
  );
};
